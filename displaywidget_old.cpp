...
DisplayWidget_old::DisplayWidget_old(QString newFieldName, DataType::dataType FieldType, bool Edit,  QWidget *parent) :
...
DisplayWidget_old::DisplayWidget_old(QString newFieldName, DataType::dataType FieldType, QVariant Value, bool Edit,  QWidget *parent)
    :QStackedWidget(parent)
{
    m_Value = Value;
    isEdit=Edit;
...
void DisplayWidget_old::construct(){
    ...
    case DataType::Text:
        ...
        connect(ShortText,SIGNAL(textEdited(QString)),this,SLOT(ValueChange()));
    ...
    case DataType::LongText:
        ...
        connect(LongText,SIGNAL(textChanged()),this,SLOT(ValueChange()));
        TextDisplay = new QLabel(NEditable);
    ...
    case DataType::Image:
        ...
        ImageDisplay->setStyleSheet("border: 20px solid black");
        ImageEdit->setStyleSheet("border: 20px solid black");
...
void DisplayWidget_old::imagesChanged(){
...
void DisplayWidget_old::reload(){
    ...
    case DataType::LongText:{
        qDebug()<<"Reloded";
        if(m_Value.toString()!=LongText->toPlainText()){
            LongText->setText(m_Value.toString());
            TextDisplay->setText(m_Value.toString());
        }
    }
...
void DisplayWidget_old::ValueChange(){
    qDebug()<<"Value Changed: ";
    switch(Type){
    case DataType::Text:
        qDebug()<<ShortText->text();
        setValue(ShortText->text());
        break;
    case DataType::LongText:
        qDebug()<<LongText->toPlainText();
...
void DisplayWidget_old::setImages(){
...
void DisplayWidget_old::addImages(){
    QStringList filenames=QFileDialog::getOpenFileNames(this,"Add Images","/home","Images (*.png *.gif *.jpg *jpeg)");
...
void DisplayWidget_old::removeImages(){
...
void DisplayWidget_old::updateValue(){
...
void DisplayWidget_old::changeImage(){
...
void DisplayWidget_old::removeImage(){
    m_Value="";
    ImageDisplay->clear();
    ImageEdit->clear();
}
